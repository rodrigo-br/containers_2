...
template<typename T>
void write_vector(ft::vector<T> &v, std::ofstream& os) {
...
template<typename T>
void write_vector(std::vector<T> &v, std::ofstream& os) {
...
void test_vector()
{
	...
	std::ofstream os;
	os.open("stdvector.txt", std::ios::app);
	{
	...
	std::cout << "std::vector time: " << (time_now() - start) << std::endl;
	os.close();
}
...
void test_vector()
{
	size_t start = time_now();
	std::ofstream os;
	os.open("ftvector.txt", std::ios::app);
	{
		vector<int> first;                                // empty vector of ints
		vector<int> second (4,100);                       // four ints with value 100
		vector<int> third (second.begin(),second.end());  // iterating through second
	...
	std::cout << "ft::vector time: " << (time_now() - start) << std::endl;
	os.close();
}
...
void test_map()
{
	size_t start = time_now();
	std::ofstream os;
	os.open("stdmap.txt", std::ios::app);
	{
		map<char,int> mymap;
		...
		os << anothermap.size() << "\n"
			...
			<< anothermap.rend()->second << "\n";
	}
	std::cout << "std::map time: " << (time_now() - start) << std::endl;
}
...
void test_map()
{
	...
	std::cout << "ft::map time: " << (time_now() - start) << std::endl;
}
